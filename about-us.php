...
<?php if (have_rows('main')) : ?>
    ...
    ?>
        <section class="flex bg-no-repeat bg-cover bg-black bg-left-bottom h-[683px] items-end justify-end lg:h-[594px]" style="background-image: url(<?php echo esc_url($bg_image); ?>);">
