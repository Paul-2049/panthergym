...
<section class="flex items-end justify-end <?= !is_lost_password_page() ? 'h-[505px] lg:h-[500px]' : 'h-[130px] md:h-[177px]'; ?> relative">
    ...
    <div class="flex items-center 2xl:pl-[101px] bg-no-repeat bg-panther-red-100 bg-right-top clip-left h-[163px] justify-start lg:bg-red-bg lg:bg-transparent lg:h-[351px] lg:items-end lg:pb-[36px] lg:pl-[8%] lg:pr-[20px] lg:translate-y-[10%] lg:w-[50%] pb-[43px] pl-[12%] pt-[33px] text-left translate-y-[27%] w-[95%] xl:w-[48%] opacity-90">
