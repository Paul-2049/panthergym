...
<section class="pt-[44px] pb-[55px] lg:pb-[114px]">
    <div class="flex flex-col lg:flex-row max-w-[1290px] w-full mx-auto px-[15px]">
        <div class="filter-js flex flex-col max-w-[297px] w-full fixed lg:static top-0 left-0 -translate-x-full transition-transform duration-200 ease-in lg:translate-x-0 h-full z-10 bg-white justify-center lg:justify-start py-[20px] lg:py-0">
            ...
            <span class="lg:px-[22px] font-privacy leading-[1.5] text-[20px] font-bold lg:mb-[22px] block cursor-pointer lg:cursor-default relative mb-[15px] pl-[15px]">
            ...
            <ul class="lg:mr-[-15px] lg:h-auto mb-[20px] lg:mb-0 flex flex-col overflow-y-auto lg:overscroll-y-none">
                ...
                foreach ($product_categories as $category) :
                    if (!in_array($category->term_id, $excluded_category_ids)) :
                ?>
                        <li class="tab-item" data-cat="<?php echo esc_attr($category->slug); ?>"><?php echo esc_html($category->name); ?></li>
                <?php
                    endif;
                endforeach;
                ?>
        ...
        <div class="lg:border-l-[1px] lg:border-black">
            <h1 class="text-center mb-[25px] lg:mb-[98px] font-privacy font-bold text-panther-red-100 text-[36px] lg:text-[68px] leading-[1.1] italic uppercase">
                <?php echo __('Shop'); ?> <span class="current-cat text-black text-[24px] lg:text-[36px]"></span>
            </h1>
            <div class="open-filter text-left text-[22px] flex items-center justify-start gap-2 lg:hidden mb-[25px] cursor-pointer text-black hover:text-panther-red-100 transition-colors duration-200 ease-in hover:fill-panther-red-100 fill-black">
                Filter
                <span>
                    <svg id="Group_35" data-name="Group 35" xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 66.58 57.184">
        ...
        <section class="relative lg:py-[68px] py-[46px] pt-0 bg-white lg:pt-0">
            ...
            <div class="relative flex flex-col hadow-[0_0_40px_0_#00000029] rounded-[8px] overflow-hidden max-w-[1200px] sm:mx-auto mx-5">
                ...
                <div class="flex flex-col justify-center sm:self-end md:w-[820px] sm:py-[80px] sm:px-[60px] px-[25px] pb-[60px] pt-[300px] relative z-[1]">
                    ...
                    <p class="font-bold text-white font-privacy italic leading-[42px] text-left lg:hidden mb-[20px] text-[38px]"><?php echo $title1; ?></p>
