...
<?php if (have_rows('main')) : ?>
  ...
  ?>
    <section class="flex bg-no-repeat bg-cover bg-[30%] bg-black h-[683px] items-end justify-end lg:h-[594px] xl:bg-left-bottom" style="background-image: url(<?php echo esc_url($bg_image); ?>);">
