      ...
      <div class="flex flex-col w-full items-center mx-auto px-[15px] max-w-[1470px]">
        ...
        if ($products) : ?>
          <div class="auto-rows-auto bm:grid-cols-2 gap-4 grid grid-cols-1 lg:grid-cols-4 lg:mb-[66px] lg:mt-[64px] mb-[70px] mt-[48px]">
            ...
            ?>
              <a href="<?php the_permalink(); ?>" class="no-underline rounded-[6px] border-transparent duration-[0.3s] ease-in transition-all border-b-[8px] hover:border-panther-red-100 hover:shadow-card-shadow lg:px-[41px] pb-[49px] product-cart pt-[28px] px-[46px]">
