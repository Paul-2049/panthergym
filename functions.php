...
function filter_products()
{
	...
	if ($query->have_posts()) {
		while ($query->have_posts()) {
			...
			<a href="<?php the_permalink(); ?>" class="product-cart no-underline py-[15px] px-[10px] rounded-[6px] hover:shadow-card-shadow transition-all duration-[0.3s] ease-in border-b-[8px] hover:border-panther-red-100 border-transparent">
...
// Prohibiting updates plugin Seraphinite Accelerator
