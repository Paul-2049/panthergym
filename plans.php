...
<?php if (have_rows('main')) : ?>
    ...
    ?>
        <section class="flex bg-black bg-cover bg-left-top bg-no-repeat h-[683px] items-end justify-end lg:h-[638px]" style="background-image: url(<?php echo esc_url($bg_image); ?>);">
            <div class="flex items-center justify-start 2xl:pl-[101px] bg-no-repeat bg-panther-red-100 bg-right-top clip-left h-[163px] pb-[43px] pl-[12%] pt-[33px] text-left translate-y-[27%] w-[95%] xl:bg-red-bg xl:bg-transparent xl:h-[461px] xl:items-end xl:pb-[40px] xl:pl-[8%] xl:pr-[20px] xl:translate-y-[10%] xl:w-[48%] opacity-90">
...
<?php if (have_rows('plan_membership')) : ?>
    ...
    ?>
        <section class="lg:pb-[108px] lg:pt-[148px] pb-[72px] pt-[104px] px-[30px]">
            ...
            <div class="w-full mx-auto auto-rows-auto gap-[15px] grid grid-cols-1 max-w-[1300px] md:grid-cols-4 px-[30px]">
